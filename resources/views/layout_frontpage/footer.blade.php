<footer class="page-footer font-small footer3">
    <div class="container text-center text-md-left">
        <div class="row">
            <div class="col-md-3 footer-cms footer-column footer-left d-lg-flex d-lg-block align-items-center">
                <div class="ttcmsfooter">
                    <div class="footer-logo"><img src="{{ asset('frontpage/img/logos/footer-logo.png') }}" alt="footer-logo"></div>
            ...
            <div class="col-md-9 footer-column footer-right">
                <div class="col-sm-12  footer-column newsletter float-left p-0">
                    <div class="block-newsletter">
                        <div class="parallax"
                            style="background-image: url(&quot;undefined&quot;); background-position: 50% 49.4179%;">
                            <div class="container">
                                <div class="row">
                                    <div class="tt-newsletter col-sm-6">
