                                ...
                                <div class="value">
                                    @if ($attribute->attribute_values)
                                        @foreach ($attribute->attribute_values as $value)
                                            <div class="valueItem">
                                                <a href="{{ route('admin.attributeValue.edit', $value) }}">
                                                    <div class="name">
                                                        {{ $value->value }}
                                                    </div>
                                                </a>
        ...
        <div class="col-md-4">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Create Attributes Values</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{ route('admin.attributeValue.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
