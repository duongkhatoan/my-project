        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ $prefix == 'admin/category' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'admin.category.index' ? 'active' : '' }}">
                        <a href="{{ route('admin.category.index') }}">
                            <i class="ti-more"></i>List category
                        </a>
                    </li>
                    <li class="{{ $route == 'admin.category.create' ? 'active' : '' }}">
                        <a href="{{ route('admin.category.create') }}">
                            <i class="ti-more"></i>Create category
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview {{ $prefix == 'admin/brand' ? 'active' : '' }}">
                <a href="{{ route('admin.brand.index') }}">
                    <i data-feather="mail"></i> <span>Brand</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-right pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li class="{{ $route == 'admin.brand.index' ? 'active' : '' }}">
                        <a href="{{ route('admin.brand.index') }}"><i class="ti-more"></i>All brand</a>
                    </li>
                    <li class="{{ $route == 'admin.brand.create' ? 'active' : '' }}">
                        <a href="{{ route('admin.brand.create') }}"><i class="ti-more"></i>Create brand</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview {{ $prefix == 'admin/product' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'admin.product.index' ? 'active' : '' }}">
                        <a href="{{ route('admin.product.index') }}"><i class="ti-more"></i>All products</a>
                    </li>
                    <li class="{{ $route == 'admin.product.create' ? 'active' : '' }}">
                        <a href="{{ route('admin.product.create') }}"><i class="ti-more"></i>Create Product</a>
                    </li>
                </ul>
            </li>
            <li class="treeview {{ $prefix == 'admin/post' ? 'active' : '' }}">
                <a href="#">
                    <i data-feather="file"></i>
                    <span>Posts</span>
                    <span class="pull-right-container">
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'admin.post.index' ? 'active' : '' }}">
                        <a href="{{ route('admin.post.index') }}"><i class="ti-more"></i>All posts</a>
                    </li>
                    <li class="{{ $route == 'admin.post.create' ? 'active' : '' }}">
                        <a href="{{ route('admin.post.create') }}"><i class="ti-more"></i>Create post</a>
                    </li>
                    <li class="{{ $route == 'admin.postcategory.index' ? 'active' : '' }}">
                        <a href="{{ route('admin.postcategory.index') }}"><i class="ti-more"></i>Post categories</a>
                    </li>
                </ul>
            </li>
