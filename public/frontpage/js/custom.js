...
$(document).ready(function () {
    ...
    /*--- start blog js ----*/
    $(
        ".layout1 .smartblog-content,.layout5 .smartblog-content,.layout2 .smartblog-content"
    ).owlCarousel({
        items: 3, //1 items above 1000px browser width
        nav: false,
        navText: [
...
surplus.wrapAll(
    '<li class="more_menu nav-item dropdown"><ul class="menu-dropdown cat-drop-menu">'
);
$(".more_menu").prepend(
    '<a href="#" class="nav-link dropdown-toggle text-uppercase">More</a>'
);
